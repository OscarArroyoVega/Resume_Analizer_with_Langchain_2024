# Resume Analyser, many LLMs consensus to reduce allucinations, bias and outlier. This is a ReAct Agent deno using Unify LLMs. Langchain as orchestrator. June 2024
